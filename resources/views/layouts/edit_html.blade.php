        ...
        <div class="col-md-4" style="" >
              ...
              <table class="table">
                <tr>
                  ...
                  <td><input type="input" id="namaTrayek" class="form-control" placeholder="ciroyom - antapani"></td>
                </tr>
                <tr>
                  <td><label for="exampleInputPassword1">
                        Route Id
                    </label></td>
                  <td><input type="input" id="route_id" class="form-control" ></td>
                </tr>
                <tr>
                  <td><label for="exampleInputPassword1">
                        route_color
                  ...
                  <td>
                    ...
                    <div id="colorSelector">
                      ...
                      <div style="height: 100%; width: 100%"> Changes Color </div>
                    </div>
                ...
                <tr>
                  ...
                  <td><input type="input" id="price" class="form-control" ></td>
                </tr>
                <tr>
                  <td><label for="exampleInputPassword1">
                        Image
                  ...
                  <td>
                    ...
                    <input type="input" id="image" class="form-control" >
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <textarea id="shape_id" class="form-control" ></textarea>
                  </td>
