...
<html>
		...
		var increase = 0;
	 	...
	 	function CenterControl(controlDiv, map) {
		    ...
		    controlText.innerHTML = '<table style="text-align:left;width:100%">'
		    							...
		    							+'</tr>'
		    							+'<tr>'
		    								+'<td><a id="add_nodex" onclick="add_node()">Add Node</a></td>'
		    							+'</tr>'
		    							+'<tr>'
		    								+'<td><a id="add_linex" onclick="add_line()">Add Line</a></td>'
		    							+'</tr>'
		    							+'<tr>'
		    								+'<td><a id="add_destinationx" onclick="add_destination()">Add Destination</a></td>'
		    							+'</tr>'
		    							+'<tr>'
		    								+'<td>'
					...
					*/
					google.maps.event.addListener(marker, "click", function (evt) 
					{
						...
						if( __global_line == true ){
							...
							console.log(path);
							console.log(__global_first_line);
  ...
  <body>
	...
	<img class='showx hidden' src='http://latcoding.com/wp-content/uploads/2015/08/graphnya.png'/>
  </body>
</html>